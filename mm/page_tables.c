...
static inline
bool _is_table_idx_implemented(uint_fast16_t table_idx)
{
...
static inline
uint_fast8_t _table_idx2array_idx(uint_fast16_t table_idx)
{
...
uint32_t page_tables_get_vaddr(uint_fast16_t table_idx)
{
