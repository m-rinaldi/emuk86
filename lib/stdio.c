...
int vsprintf(char *buf, const char *fmt, va_list args)
{
    ...
    for (str=buf ; *fmt ; ++fmt) {
        ...
        case 'o':
            str = number(str, (int) va_arg(args, unsigned long), 8,
        ...
        case 'x':
            flags |= SMALL;
        case 'X':
            str = number(str, (int) va_arg(args, unsigned long), 16,
                field_width, precision, flags);
            break;
        ...
        case 'i':
            flags |= SIGN;
        case 'u':
            str = number(str, (int) va_arg(args, unsigned long), 10,
                field_width, precision, flags);
            break;
